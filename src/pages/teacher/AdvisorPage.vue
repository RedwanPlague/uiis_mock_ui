<template>
  <q-page padding>
    ...
    >
      ...
      <q-tab name="movies" label="Registration" />
    </q-tabs>
        ...
        <q-dialog v-model="dialogOpen">
          <q-card>
            ...
            <q-card-actions class="q-pr-md" align="right">
              <q-btn label="Forward" color="primary" v-close-popup unelevated
                @click="pendings.splice(0, 1)"
              ></q-btn>
              <q-btn label="Close" color="primary" flat v-close-popup unelevated></q-btn>
            </q-card-actions>
          </q-card>
        </q-dialog>
      </q-tab-panel>
